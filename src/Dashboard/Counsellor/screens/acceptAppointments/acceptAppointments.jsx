      ...
      try {
        ...
        SetUpcomingAppointments(
          data.message.filter(msg => {
            ...
            const appointmentDate = new Date(year, month - 1, day + 1); // month - 1 because months are zero-based in JavaScript
        ...
        SetPendingAppointments(
          data.message.filter(msg => {
          const [day, month, year] = msg.date_slot.split('/');
          const appointmentDate = new Date(year, month - 1, day + 1); // month - 1 because months are zero-based in JavaScript. +1 to ensure it is displayed till EOD
